...
import cn.qatime.player.barrage.controller.DanmakuFilters;
...
public class DanmakuContext {
    ...
    private <T> void setFilterData(String tag, T data, boolean primary) {
        ...
        DanmakuFilters.IDanmakuFilter<T> filter = (DanmakuFilters.IDanmakuFilter<T>) mDanmakuFilters.get(tag, primary);
        filter.setData(data);
    }
