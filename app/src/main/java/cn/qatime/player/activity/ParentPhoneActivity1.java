 ...
 */
public class ParentPhoneActivity1 extends BaseActivity implements View.OnClickListener {
                ...
                addToRequestQueue(new DaYiJsonObjectRequest(Request.Method.PUT, UrlUtils.getUrl(UrlUtils.urlPersonalInformation + BaseApplication.getUserId() + "/parent_phone", map), null, new VolleyListener(this) {
                    ...
                    protected void onSuccess(JSONObject response) {
                        ...
                        if (!response.isNull("data")) {
                            Logger.e("验证成功");
                            Toast.makeText(ParentPhoneActivity1.this, getResourceString(R.string.bind_parent_phone_success), Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(ParentPhoneActivity1.this, SecurityManagerActivity.class);
                            startActivity(intent);
                        } else {
                            Toast.makeText(ParentPhoneActivity1.this, getResourceString(R.string.bind_parent_phone_failed), Toast.LENGTH_SHORT).show();
                        }
                    ...
                    protected void onError(JSONObject response) {
                        ...
                        try {
                            ...
                            if (error.getString("msg").contains("Current password")) {
                                Toast.makeText(ParentPhoneActivity1.this, getResourceString(R.string.password_error), Toast.LENGTH_SHORT).show();
                            } else if (error.getString("msg").contains("Captcha confirmation")) {
                                Toast.makeText(ParentPhoneActivity1.this, getResourceString(R.string.code_error), Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(ParentPhoneActivity1.this, getResourceString(R.string.bind_parent_phone_failed), Toast.LENGTH_SHORT).show();
                            }
