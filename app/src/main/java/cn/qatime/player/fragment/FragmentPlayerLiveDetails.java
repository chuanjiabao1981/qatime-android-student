...
public class FragmentPlayerLiveDetails extends BaseFragment {
    ...
    private FragmentPlayerLiveTeacherDetails player2;
    private FragmentPlayerLiveClassDetails player1;
    private FragmentPlayerLiveClassList player3;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        player1 = new FragmentPlayerLiveClassDetails();
        player2 = new FragmentPlayerLiveTeacherDetails();
        player3 = new FragmentPlayerLiveClassList();
