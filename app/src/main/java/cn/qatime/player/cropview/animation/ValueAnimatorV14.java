...
public class ValueAnimatorV14 implements cn.qatime.player.cropview.animation.ValueAnimator, Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
    private static final int DEFAULT_ANIMATION_DURATION = 150;
    private ValueAnimator animator;
    private ValueAnimatorListener animatorListener = new ValueAnimatorListener() {
        @Override
    ...
    @Override
    public void addAnimatorListener(ValueAnimatorListener animatorListener) {
