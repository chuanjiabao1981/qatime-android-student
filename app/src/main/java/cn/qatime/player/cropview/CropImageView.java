package cn.qatime.player.cropview;
...
import cn.qatime.player.cropview.animation.ValueAnimator;
import cn.qatime.player.cropview.animation.ValueAnimatorListener;
import cn.qatime.player.cropview.animation.ValueAnimatorV14;
import cn.qatime.player.cropview.animation.ValueAnimatorV8;
import cn.qatime.player.cropview.callback.Callback;
import cn.qatime.player.cropview.callback.CropCallback;
import cn.qatime.player.cropview.callback.LoadCallback;
import cn.qatime.player.cropview.callback.SaveCallback;
import cn.qatime.player.cropview.util.Utils;
...
public class CropImageView extends ImageView {
    ...
    private void handleStyleable(Context context, AttributeSet attrs, int defStyle,
        ...
        try {
            ...
            mInitialFrameScale = constrain(ta.getFloat(R.styleable.scv_CropImageView_scv_initial_frame_scale, DEFAULT_INITIAL_FRAME_SCALE), 0.01f, 1.0f,
    ...
    private void recalculateFrameRect(int durationMillis) {
        ...
        if (mIsAnimationEnabled) {
            ...
            animator.addAnimatorListener(new ValueAnimatorListener() {
                @Override
